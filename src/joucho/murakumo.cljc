...
(defn collection
  [name]
  (str "com.etzhayyim.joucho." name))

(def cell-specs {
  :scoreemotion {:legacy-cell "com-etzhayyim-joucho-scoreEmotion"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "scoreemotion")]
     :required-gates common-gates
     :trigger "manifest cell scoreemotion"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :get {:legacy-cell "com-etzhayyim-joucho-coverage-get"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :score {:legacy-cell "com-etzhayyim-joucho-score"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "score")]
     :required-gates common-gates
     :trigger "manifest cell score"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :review {:legacy-cell "com-etzhayyim-joucho-review"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "review")]
     :required-gates common-gates
     :trigger "manifest cell review"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :event {:legacy-cell "com-etzhayyim-apps-maps-event"
     :phase :event
     :murakumo-node "reuben"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :activity {:legacy-cell "com-etzhayyim-apps-omatsuri-activity"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "activity")]
     :required-gates common-gates
     :trigger "manifest cell activity"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :order {:legacy-cell "com-etzhayyim-apps-okaimono-order"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "order")]
     :required-gates common-gates
     :trigger "manifest cell order"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :record {:legacy-cell "com-etzhayyim-apps-kaigo-record"
     :phase :event
     :murakumo-node "reuben"
